...
$('#botao').keydown(function(event){
  if(event.which === 13){
  	...
  	//depois vai direcionar o foco pra outro campo do form, pra nao dar o bug
  	$('#nome').focus();
  	$('#popnome').focus();
  }
...
$(".blue").click(function(){
	//ao clicar na div com class blue vai mudar a cor do header, colocando a msm cor da div
	$('header').removeClass('cabecalho');
	$('header').addClass('azul');
	//$('.panel-heading').css('background-color',$('.blue').css('background-color'));
})	
})
...
//comando jquery para mudar status. Quando o botao com id=mudaStatus for clicado, uma var $t vai receber
//o conteudo text desse botao, se o texto q estiver for 'Bloquear', quer dizer
// que é para bloquear o cliente; entao vai passar o status do cliente para Bloqueado ,
//sera trocado o texto do proprio botao para 'Ativar' e tbm trocado a cor do botao para verde 
//Quando o botao for clicado, caso o q tenha no texto for 'Ativar', vai fazer o inverso: passar o status
// do cli para ativo e mudar o nome do botao e a cor
$(function(){
	$('#mudaStatus').on('click',function(){
		...
		if($t == "Ativar"){
			...
			$('#status_cli').val("Ativado");
		}

	})


	//o msm do mudaStatus, mas agora com o tipo de conta do func
	$('#mudaConta').on('click',function(){

		var $c = $(this).text();
		if($c == "Trocar para administrador"){
			$(this).text("Trocar para funcionário");
			$(this).attr('class','btn btn-primary');
			$('#tipo_ct').val("admin");
		}

		if($c == "Trocar para funcionário"){
			$(this).text("Trocar para administrador");
			$(this).attr('class','btn btn-success');
			$('#tipo_ct').val("funcionario");
		}
